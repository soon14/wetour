  ...
  <div class="mod-config">
    <basic-container>
      <div class="filter-container">
        ...
        />
        <el-select
          v-model="searchForm.licenseExpiredStatus"
          style="width: 140px"
          class="filter-item"
          filterable clearable
        >
          <el-option :value="undefined" label="全部驾驶状态" />
        ...
        <el-table :data="dataList" border v-loading="dataListLoading">
          ...
          >
            <template slot-scope="scope">
               {{scope.row.prefixMobile?scope.row.prefixMobile:''}} {{scope.row.mobile}}
            </template>
          </el-table-column>
          <!-- <el-table-column
            prop="partnerName"
          ...
          >
           ...
           <el-table-column
            prop="licenseExpiredStatus"
            header-align="center"
            align="center"
            label="驾驶证状态"
          >
            <template slot-scope="scope">
               {{scope.row.licenseExpiredStatus | licenseExpiredStatusFil}}
            </template>
          </el-table-column>
           <el-table-column
            prop="gender"
          ...
          <el-table-column header-align="center" align="center" label="操作">
            <template slot-scope="scope">
              <el-button
                ...
                v-if="permissions.wetour_driverapply_edit && scope.row.applyStatus == 0"
                type="text"
                size="small"
                @click="
                  addOrUpdateHandle(
...
<script>
import { fetchAppleList, delObj, getAppleObj } from "@/api/wetour/driver";
import TableForm from "./driver-apple-form";
  ...
  data() {
    return {
      ...
      searchForm: {
        ...
        mobile:'',
        countryCn:'',
        licenseExpiredStatus:undefined,
        startTime:'',
        endTime:'',
        gender:'',
        applyStatus:'',
