<template>
	<view class="u-numberbox">
		<!--class="u-icon-minus" :class="{ 'u-icon-disabled': disabled || inputVal <= min }" -->
		<view  @touchstart.stop.prevent="btnTouchStart('minus')" @touchend.stop.prevent="clearTimer" 
			...
			<image v-if="disabled || inputVal <= min" style="width: 44rpx;height: 44rpx;" src="http://youba-static.oss-cn-hangzhou.aliyuncs.com/newwetour/newImg/minus_disabled.png"></image>
			<image v-else style="width: 44rpx;height: 44rpx;" src="http://youba-static.oss-cn-hangzhou.aliyuncs.com/newwetour/newImg/minus.png"></image>
		...
		<input :disabled="disabledInput || disabled" :cursor-spacing="getCursorSpacing" :class="{ 'u-input-disabled': disabled }"
			...
			<!-- :class="{ 'u-icon-disabled': disabled || inputVal >= max }" class="u-icon-plus"-->
		<view  @touchstart.stop.prevent="btnTouchStart('plus')" @touchend.stop.prevent="clearTimer" 
		   >
		   <!--  :style="{
				background: bgColor,
				height: inputHeight + 'rpx',
			...
			<image v-if="disabled || inputVal >= max" style="width: 44rpx;height: 44rpx;" src="http://youba-static.oss-cn-hangzhou.aliyuncs.com/newwetour/newImg/plus_disabled.png"></image>
			<image v-else style="width: 44rpx;height: 44rpx;" src="http://youba-static.oss-cn-hangzhou.aliyuncs.com/newwetour/newImg/plus.png"></image>
